...
style="font-size:12px;color:#d4922a;font-weight:600;">Get Directions →</a>
    ...
    return (
        <div ref={mapRef} className="footer-map" style={{ widht: "100%", overflow: "hidden" }} />
    );
}
...
export default function FooterSection() {
    return (
        <footer className="footer">
            <div className="mx-auto max-w-7x1 px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32 2xl:max-w-[1600px]">
                {/* MAP */}
